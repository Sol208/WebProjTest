...
<form action="/member/Market/PostModify_Reg" method="post">
	<table border="">
		<tr>
			<td colspan="2"><input type="text" name="title" value="${dto.title }" /></td>
		</tr>
		<tr>
			<th>판매자 아이디</th>
			<td>${dto.user_id }  <input type="hidden" name="dto.user_id" value="${dto.user_id }" /></td>
		</tr>
		<tr>
			<th>판매자 이메일</th>
		...
		<tr>
			<td colspan="2">
				<textarea name="content" id="content" cols="70" rows="50"
	    						style="width:500px; height:500px" >${dto.content }</textarea>
