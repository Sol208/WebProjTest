						...
						<div class="input-group mb-3">
							<input type="text" class="form-control" id="inputEmailForm"
								...
								<option value="google.com"
									<c:if test="${email_address == \"google.com\" }"> selected</c:if>>google.com</option>
				...
				<div class="row" style="margin-top: 20px">
					...
					<div class="col-4">
						<input type="text" class="form-control" id="postcode"
							...
							name="extraAddress" placeholder="참고사항" value="" disabled>
					</div>
					<div class="col-4">
						<input type="text" class="form-control" id="address"
							name="address" placeholder="주소" value="${User.address }" disabled>
